    ...
    rules: {
      types: {
        ...
        balance_count: {
          ...
          description: "Répartir équitablement le dénombrement d'élèves ou d'attributs dans chaque classe possédant l'attribut."
        },
        balance_class_count: {
          name: 'Équilibrer dans une classe',
          description: "Répartir équitablement le dénombrement de plusieurs attributs dans une même classe."
        },
        maximize_class_size: {
          name: 'Maximiser la taille des classes',
          description: "Réduire au maximum le nombre de classes, en les remplissant autant que possible."
        },
        maximize_classes: {
