// Script copied from https://github.com/PedakiHQ/pedaki/blob/main/scripts/prepare-release.mjs
// Update it there first, then copy it here.
// The only change is githubBaseUrl.
...
const githubBaseUrl = 'https://github.com/pedakihq/pedaki-community';
...
inquirer.prompt(questions).then(async (answers) => {
    ...
    newVersion += preReleaseSuffix((answers.versionType === 'skip' || answers.version === currentVersion.split("-", 1)[0]), isPreRelease);
